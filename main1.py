...
class Particle(arcade.Sprite):
    def __init__(self, asset, scale, x, y, dx, dy, ax, ay, decay):
        ...
        self.particle_colors = [
            ...
            ,(open_color.green_1, 8)
            ,(open_color.green_2, 7)
            ,(open_color.green_3, 6)
            ,(open_color.green_4, 5)
            ,(open_color.green_5, 4)
        ]
...
class Window(arcade.Window):
    ...
    def update(self, delta_time):
        ...
        if self.mouse_down:
            ...
            particle = Particle('fire_01',scale,x,y,dx,dy,ax,ay,decay)
